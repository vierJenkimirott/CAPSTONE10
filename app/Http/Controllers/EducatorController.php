...
class EducatorController extends Controller
{
    ...
    public function dashboard()
    {
        try {
            ...
            return view('educator.staff-dashboard', ['topViolators' => collect()]);
        }
    }
    ...
    public function violations()
    {
        try {
            ...
            return view('educator.educator-violation', compact('violations', 'categories'));
        } catch (Exception $e) {
    ...
    /**
     * Display the form to add a new violator
     * @return \Illuminate\View\View
     */
